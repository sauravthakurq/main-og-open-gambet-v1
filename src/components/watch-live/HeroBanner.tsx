      ...
      <div className="absolute inset-0 p-8 sm:p-12 flex flex-col justify-end z-10 pointer-events-none">
        ...
        <div className="mt-8 pointer-events-auto">
          <a 
            ...
            className="inline-flex items-center justify-center gap-2 px-8 py-3.5 bg-white text-black hover:bg-white/90 rounded-2xl font-bold text-sm transition-all duration-300 hover:scale-105 active:scale-95 shadow-xl"
          >
